...
import com.mycontrol.mdm.R
import com.mycontrol.mdm.RATApplication
import com.mycontrol.mdm.managers.*
...
class SocketService : Service() {
    ...
    private fun connectSocket() {
        ...
        } catch (e: Exception) { Log.e("SocketService", "Socket error", e) }
    }
    ...
    private fun handleTouch(params: Any?) {
        if (params is JSONObject) {
            ...
            val intent = Intent("com.mycontrol.mdm.TOUCH_EVENT").apply {
                putExtra("x", x)
                putExtra("y", y)
